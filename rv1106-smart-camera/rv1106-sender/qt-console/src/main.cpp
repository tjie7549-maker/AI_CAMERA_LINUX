...
int main(int argc, char *argv[])
{
    ...
    QCommandLineOption daemonSocketOption(
        QStringList() << QStringLiteral("daemon-socket"),
        QStringLiteral("camera-daemon Unix socket"), QStringLiteral("path"),
        QStringLiteral("/userdata/rv1106-smart-camera/run/camera-daemon.sock"));
