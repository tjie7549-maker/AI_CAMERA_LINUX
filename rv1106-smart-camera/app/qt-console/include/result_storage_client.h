...
private:
    bool post(const QUrl &url, const QJsonObject &payload,
              const QString &source, const QString &requestId);
    QNetworkAccessManager *manager_; QNetworkReply *reply_; QNetworkReply *recoveryReply_;
    QTimer *timer_; QUrl url_; QUrl eventApiBase_;
