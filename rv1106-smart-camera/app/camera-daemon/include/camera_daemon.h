...
struct DaemonConfig {
  std::string socket_path, log_path, sensor_subdev, sender_path, bridge_path, npu_path, iq_dir, isp_control_socket, rkipc_path, rkipc_socket, rtsp_url;
  ...
  bool start_pipeline, start_npu, auto_ae;
};
